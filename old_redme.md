...
4. **Rozwiązywanie problemów i podejmowanie decyzji z wykorzystaniem komputera, stosowanie podejścia algorytmicznego**
    ...
    - [ ] ❌ opisuje podstawowe algorytmy i stosuje:
        ...
        2. algorytmy wyszukiwania i porządkowania (sortowania), np.: - [ ] ✍ algorytmy sortowania ciągu liczb: bąbelkowy, przez wybór, przez wstawianie liniowe, przez scalanie, szybki, kubełkowy
        3. algorytmy numeryczne, np.: - [x] ✔ szybkie podnoszenie do potęgi - [ ] ❌ wyznaczanie miejsc zerowych funkcji metodą połowienia
